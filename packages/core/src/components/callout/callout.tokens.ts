/** TDGS callout tokens — contenu éditorial mis en avant. */
export const callout = {
  defaults: {
    background: 'var(--tds-callout-bg)',
    border: 'var(--tds-callout-border)',
    accent: 'var(--tds-callout-accent)',
    color: 'var(--tds-callout-color)',
  },
  variants: {
    neutral: {
      background: 'var(--tds-bg-subtle)',
      border: 'var(--tds-border)',
      accent: 'var(--tds-text-muted)',
      color: 'var(--tds-text)',
    },
    info: {
...
export type CalloutVariant = keyof typeof callout.variants;
export type CalloutTokens = typeof callout;
