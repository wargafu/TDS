...
export const input = {
  defaults: {
    ...
    transition:
      'border-color var(--tds-motion-fast) var(--tds-easing-standard), background-color var(--tds-motion-fast) var(--tds-easing-standard), color var(--tds-motion-fast) var(--tds-easing-standard)',
