...
description: Pattern de connexion TDGS — email/mot de passe, gestion des erreurs, accessibilité.
sidebar:
  order: 2
---
...
<body>
  ...
  <header class="tds-header" role="banner">
    <div class="tds-header__brand">
      ...
      <span class="tds-header__title">Nom du ministère ou service</span>
    </div>
  </header>
